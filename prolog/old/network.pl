...
'Application'(_) :- fail.
'BGP'(_) :- fail.
'BackendFunction'(_) :- fail.
'ClusterTemplate'(_) :- fail.
'Component'(_) :- fail.
'ComputeLimits'(_) :- fail.
'ComputeUsage'(_) :- fail.
'Container'(_) :- fail.
'DHCP'(_) :- fail.
'DNS'(_) :- fail.
'DatabaseFunction'(_) :- fail.
'DeploymentUnit'(_) :- fail.
'Device'(_) :- fail.
'Electricity'(_) :- fail.
'ExecutionEnvironment'(_) :- fail.
'FTP'(_) :- fail.
'FirewallFunction'(_) :- fail.
'Flavor'(_) :- fail.
'FlavorAccess'(_) :- fail.
'FloatingIP'(_) :- fail.
'Function'(_) :- fail.
...
'IPv4'(_) :- fail.
'IPv6'(_) :- fail.
'IRSenderReceiver'(_) :- fail.
'Image'(_) :- fail.
'Interface'(_) :- fail.
'InternalNetwork'(_) :- fail.
'KVM'(_) :- fail.
'Keypair'(_) :- fail.
'Kubernetes'(_) :- fail.
'LDAP'(_) :- fail.
'LXD'(_) :- fail.
'LinuxBridge'(_) :- fail.
'LoadBalanceFunction'(_) :- fail.
'Location'(_) :- fail.
'MAC'(_) :- fail.
'MACVLAN'(_) :- fail.
'MACVTAP'(_) :- fail.
'MACsec'(_) :- fail.
'MagnumService'(_) :- fail.
'MiddleboxFunction'(_) :- fail.
'NLMON'(_) :- fail.
'NSD'(_) :- fail.
'NSILCM'(_) :- fail.
'NSLCM'(_) :- fail.
...
'OpenVSwitch'(_) :- fail.
'Openstack'(_) :- fail.
'OpenstackTerm'(_) :- fail.
'Orchestrator'(_) :- fail.
'OsmTerm'(_) :- fail.
'OverlayNetwork'(_) :- fail.
'PDU'(_) :- fail.
'POP'(_) :- fail.
'PPP'(_) :- fail.
'PTP'(_) :- fail.
'Package'(_) :- fail.
'PhysicalDevice'(_) :- fail.
'PhysicalHub'(_) :- fail.
'PhysicalMachine'(_) :- fail.
'PhysicalNetwork'(_) :- fail.
'PhysicalRouter'(_) :- fail.
'PhysicalSwitch'(_) :- fail.
'Protocol'(_) :- fail.
'RTSP'(_) :- fail.
'RouteFunction'(_) :- fail.
'SMTP'(_) :- fail.
'SNMP'(_) :- fail.
'SSH'(_) :- fail.
'SecurityGroup'(_) :- fail.
'SecurityGroupRule'(_) :- fail.
'Server'(_) :- fail.
'ServerUsage'(_) :- fail.
'Service'(_) :- fail.
'ServiceFunctionChain'(_) :- fail.
'Stack'(_) :- fail.
'SwitchFunction'(_) :- fail.
'TCP'(_) :- fail.
'Terms'(_) :- fail.
'Transmission'(_) :- fail.
'UDP'(_) :- fail.
...
'VNFR'(_) :- fail.
'VXCAN'(_) :- fail.
'VirtualDevice'(_) :- fail.
'VirtualEnvironment'(_) :- fail.
'VirtualMachine'(_) :- fail.
'VirtualNetwork'(_) :- fail.
'VirtualNetworkInterface'(_) :- fail.
'Volume'(_) :- fail.
'VolumeType'(_) :- fail.
'VolumeTypeAccess'(_) :- fail.
'VxLAN'(_) :- fail.
'Wire'(_) :- fail.
'WiredNetwork'(_) :- fail.
'WiredNetworkInterface'(_) :- fail.
'WirelessNetwork'(_) :- fail.
'WirelessNetworkInterface'(_) :- fail.
'Xen'(_) :- fail.
executionState(_) :- fail.
'TLS/SSL'(_) :- fail.
'Service'(_) :- fail.
'VirtualMachine'(_) :- fail.
compute(_,_) :- fail.
executionState(_,_) :- fail.
interfaceProperty(_,_) :- fail.
ipAddress(_,_) :- fail.
macAddress(_,_) :- fail.
network(_,_) :- fail.
role(_,_) :- fail.
...
compute(_,_) :- fail.
connected(_,_) :- fail.
connectedByWire(_,_) :- fail.
deployedOnMachine(_,_) :- fail.
descriptionProperty(_,_) :- fail.
executionState(_,_) :- fail.
existsOn(_,_) :- fail.
has(_,_) :- fail.
hasDeploymentUnit(_,_) :- fail.
hasExecutionMachine(_,_) :- fail.
hasInstance(_,_) :- fail.
hasInterface(_,_) :- fail.
hasNetworkFunction(_,_) :- fail.
hasPhysicalInterface(_,_) :- fail.
hasVirtualInterface(_,_) :- fail.
interfaceProperty(_,_) :- fail.
ipAddress(_,_) :- fail.
isDeploymentUnitOf(_,_) :- fail.
isDoing(_,_) :- fail.
isExecuting(_,_) :- fail.
isInstanceOf(_,_) :- fail.
isInterfaceOf(_,_) :- fail.
isOf(_,_) :- fail.
isOn(_,_) :- fail.
isPhysicalInterfaceOf(_,_) :- fail.
isRunningOn(_,_) :- fail.
isVirtualInterfaceOf(_,_) :- fail.
lacks(_,_) :- fail.
lacksExecutionMachine(_,_) :- fail.
lacksInstance(_,_) :- fail.
lacksPackage(_,_) :- fail.
macAddress(_,_) :- fail.
network(_,_) :- fail.
report(_,_) :- fail.
role(_,_) :- fail.
supports(_,_) :- fail.
supportsProtocol(_,_) :- fail.
target(_,_) :- fail.
topDataProperty(_,_) :- fail.
label(_,_) :- fail.
comment(_,_) :- fail.
label(_,_) :- fail.
comment(_,_) :- fail.
...
% class('http://raw.githubusercontent.com/Guilvareux/ontologies/network/network#Service') 
% class('http://raw.githubusercontent.com/Guilvareux/ontologies/network/network#VirtualMachine') 
...
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_KVM') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF1') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF2') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU_INTF') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU_INTF') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU_INTF') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU_INTF') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2') 
% namedIndividual('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU') 
...
% ontology('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network') 
% ontology('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service') 
...
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#BackendFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1') 
'BackendFunction'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#BackendFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2') 
'BackendFunction'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#BackendFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3') 
'BackendFunction'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#BackendFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2') 
'BackendFunction'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#KVM','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_KVM') 
'KVM'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_KVM').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#KVM','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM') 
'KVM'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#LinuxBridge','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0') 
'LinuxBridge'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#LinuxBridge','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0') 
'LinuxBridge'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#LoadBalanceFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB') 
'LoadBalanceFunction'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#LoadBalanceFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1') 
'LoadBalanceFunction'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#PhysicalMachine','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes') 
'PhysicalMachine'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#PhysicalMachine','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny') 
'PhysicalMachine'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#PhysicalRouter','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router') 
'PhysicalRouter'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#ServiceFunctionChain','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1') 
'ServiceFunctionChain'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VETH','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU_INTF') 
'VETH'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU_INTF').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VETH','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU_INTF') 
'VETH'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU_INTF').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VETH','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU_INTF') 
'VETH'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU_INTF').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VETH','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU_INTF') 
'VETH'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU_INTF').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VirtualMachine','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU') 
'VirtualMachine'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VirtualMachine','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU') 
'VirtualMachine'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VirtualMachine','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU') 
'VirtualMachine'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VirtualMachine','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU') 
'VirtualMachine'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#VirtualMachine','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU') 
'VirtualMachine'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#WiredNetworkInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC') 
'WiredNetworkInterface'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#WiredNetworkInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF1') 
'WiredNetworkInterface'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF1').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#WiredNetworkInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF2') 
'WiredNetworkInterface'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF2').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#WiredNetworkInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC') 
'WiredNetworkInterface'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/network/network#Service','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService') 
'Service'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService').
% classAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/network/network#VirtualMachine','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU') 
'VirtualMachine'('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU').
...
descriptionProperty(X,Y):-
     target(X,Y).
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#connectsToDeploymentUnit','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU') 
connectsToDeploymentUnit('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#minCPURequirement','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU',literal(type('http://www.w3.org/2001/XMLSchema#unsignedInt','1'))) 
minCPURequirement('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU','1').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#minCPURequirement','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU',literal(type('http://www.w3.org/2001/XMLSchema#unsignedInt','1'))) 
minCPURequirement('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU','1').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#minInstanceNumber','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2',literal(type('http://www.w3.org/2001/XMLSchema#unsignedInt','2'))) 
minInstanceNumber('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2','2').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#minMemoryRequirement','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU',literal(type('http://www.w3.org/2001/XMLSchema#float','1.0'))) 
minMemoryRequirement('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU','1.0').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#minMemoryRequirement','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU',literal(type('http://www.w3.org/2001/XMLSchema#float','1.0'))) 
minMemoryRequirement('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU','1.0').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#minStorageRequirement','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU',literal(type('http://www.w3.org/2001/XMLSchema#unsignedInt','10'))) 
minStorageRequirement('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU','10').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#minStorageRequirement','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU',literal(type('http://www.w3.org/2001/XMLSchema#unsignedInt','10'))) 
minStorageRequirement('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU','10').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#requiresDeploymentUnit','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU') 
requiresDeploymentUnit('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1_VDU').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#requiresDeploymentUnit','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU') 
requiresDeploymentUnit('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2_VDU').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#requiresFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1') 
requiresFunction('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD1').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/intent/intent#requiresFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2') 
requiresFunction('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#NFD2').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#connected','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC') 
connected('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#connected','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU_INTF','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0') 
connected('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU_INTF','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#connected','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU_INTF','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0') 
connected('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU_INTF','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#connected','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU_INTF','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0') 
connected('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU_INTF','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#connected','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC') 
connected('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#connected','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU_INTF','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0') 
connected('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU_INTF','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#connectedByWire','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF1') 
connectedByWire('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF1').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#connectedByWire','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF2') 
connectedByWire('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF2').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#existsOn','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes') 
existsOn('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_br0','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#existsOn','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny') 
existsOn('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_br0','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#has','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1') 
has('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/service#EmeraldService','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasDeploymentUnit','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU') 
hasDeploymentUnit('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasNetworkFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1') 
hasNetworkFunction('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasNetworkFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2') 
hasNetworkFunction('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasNetworkFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3') 
hasNetworkFunction('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasNetworkFunction','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB') 
hasNetworkFunction('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#EmeraldFunctionChain_1','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasPhysicalInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF1') 
hasPhysicalInterface('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF1').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasPhysicalInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF2') 
hasPhysicalInterface('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Router_INTF2').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasVirtualInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU_INTF') 
hasVirtualInterface('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU_INTF').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasVirtualInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU_INTF') 
hasVirtualInterface('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU_INTF').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasVirtualInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU_INTF') 
hasVirtualInterface('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU_INTF').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#hasVirtualInterface','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU_INTF') 
hasVirtualInterface('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU_INTF').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isDeploymentUnitOf','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1') 
isDeploymentUnitOf('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isDeploymentUnitOf','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2') 
isDeploymentUnitOf('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isDeploymentUnitOf','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3') 
isDeploymentUnitOf('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isPhysicalInterfaceOf','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes') 
isPhysicalInterfaceOf('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_NIC','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isPhysicalInterfaceOf','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny') 
isPhysicalInterfaceOf('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_NIC','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isRunningOn','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_KVM','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes') 
isRunningOn('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_KVM','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isRunningOn','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM') 
isRunningOn('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE1_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isRunningOn','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM') 
isRunningOn('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE2_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isRunningOn','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM') 
isRunningOn('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#SBE3_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isRunningOn','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny') 
isRunningOn('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny_KVM','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Tiny').
% propertyAssertion('http://raw.githubusercontent.com/Guilvareux/ontologies/main/network/network#isRunningOn','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_KVM') 
isRunningOn('http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#VLB_VDU','http://raw.githubusercontent.com/Guilvareux/ontologies/main/examples/tmf_example/live_network#Archimedes_KVM').
